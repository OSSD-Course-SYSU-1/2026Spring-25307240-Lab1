...
interface SportModeSelectionModuleTitleInfo_Params {
...
interface SportModeSelectionModule_Params {
    itemModel?: Data;
    listDirection?: Axis;
    moduleTitle?: string;
    moduleRedirectContent?: string;
...
import { Data } from "@normalized:N&&&entry/src/main/ets/generated1/viewmodel/SportModeSelectionModuleData&";
import type { DataSource } from "@normalized:N&&&entry/src/main/ets/generated1/viewmodel/SportModeSelectionModuleData&";
...
export class SportModeSelectionModule extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        ...
        this.__moduleTitle = new ObservedPropertySimplePU("运动模式选择", this, "moduleTitle");
        this.__moduleRedirectContent = new ObservedPropertySimplePU("查看更多运动", this, "moduleRedirectContent");
    ...
    setInitiallyProvidedValue(params: SportModeSelectionModule_Params) {
    ...
    updateStateVars(params: SportModeSelectionModule_Params) {
    ...
    initialRender() {
        ...
        }, Column);
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    let componentCall = new SportModeSelectionModuleTitleInfo(this, {
                        title: this.moduleTitle,
                        moduleRedirectContent: this.moduleRedirectContent,
                        onJump: () => {
                            this.jump();
                        }
                    }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/generated1/view/SportModeSelectionModule.ets", line: 58, col: 7 });
            ...
            }, { name: "SportModeSelectionModuleTitleInfo" });
        }
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            If.create();
                        ...
                        const __lazyForEachItemGenFunction = (_item, index: number) => {
                            const item = _item;
                            {
                                const itemCreation2 = (elmtId, isInitialRender) => {
                                    ...
                                    ListItem.onClick(() => {
                                        this.jump("SportModeSelectionModuleDetail" + index.toString());
                                    });
                                    ...
                                    this.observeComponentCreation2(itemCreation2, ListItem);
                                    {
                                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                                            if (isInitialRender) {
                                                ...
                                                }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/generated1/view/SportModeSelectionModule.ets", line: 75, col: 15 });
                                                ViewPU.create(componentCall);
                                                let paramsLambda = () => {
                                                    return {
                                                        icon: item.getIcon(),
...
export class SportModeSelectionModuleTitleInfo extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        super(parent, __localStorage, elmtId, extraInfo);
        if (typeof paramsLambda === "function") {
            this.paramsGenerator_ = paramsLambda;
        ...
        this.title = '';
        this.moduleRedirectContent = "查看更多运动";
        this.__appPathStack = this.initializeConsume('appPathStack', "appPathStack");
        this.onJump = undefined;
        this.setInitiallyProvidedValue(params);
        this.finalizeConstruction();
    }
    setInitiallyProvidedValue(params: SportModeSelectionModuleTitleInfo_Params) {
        if (params.title !== undefined) {
            this.title = params.title;
        }
        if (params.moduleRedirectContent !== undefined) {
    ...
    updateStateVars(params: SportModeSelectionModuleTitleInfo_Params) {
    }
    purgeVariableDependenciesOnElmtId(rmElmtId) {
        this.__currentWidthBreakpoint.purgeDependencyOnElmtId(rmElmtId);
        this.__appPathStack.purgeDependencyOnElmtId(rmElmtId);
