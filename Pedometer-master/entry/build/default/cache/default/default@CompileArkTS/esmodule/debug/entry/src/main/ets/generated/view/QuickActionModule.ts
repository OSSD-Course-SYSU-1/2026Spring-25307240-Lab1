...
import { Data } from "@normalized:N&&&entry/src/main/ets/generated/viewmodel/QuickActionModuleData&";
import type { DataSource } from "@normalized:N&&&entry/src/main/ets/generated/viewmodel/QuickActionModuleData&";
export class QuickActionModule extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        ...
        this.__moduleTitle = new ObservedPropertySimplePU("计步器功能入口", this, "moduleTitle");
        ...
        }, __Common__);
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    ...
                    }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/generated/view/QuickActionModule.ets", line: 61, col: 7 });
                                        ...
                                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                                            if (isInitialRender) {
                                                let componentCall = new VerticalGraphicTextFunctionItem1(this, {
                                                    title: item.getTitle(),
                                                    icon: item.getIcon()
                                                }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/generated/view/QuickActionModule.ets", line: 77, col: 19 });
                                                ViewPU.create(componentCall);
                                                let paramsLambda = () => {
                                                    return {
                                                        title: item.getTitle(),
