    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            NavDestination.create(() => {
                ...
                }, Column);
                {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        if (isInitialRender) {
                            ...
                            }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/generated/detail/SecondPageSearch.ets", line: 29, col: 9 });
                ...
                Column.pop();
            }, { moduleName: "entry", pagePath: "entry/src/main/ets/generated/detail/SecondPageSearch" });
...
export function SearchPageBuilder(parent = null) {
    {
        (parent ? parent : this).observeComponentCreation2((elmtId, isInitialRender) => {
            if (isInitialRender) {
                let componentCall = new SecondPageSearch(parent ? parent : this, {}, undefined, elmtId, () => { }, { page: "entry/src/main/ets/generated/detail/SecondPageSearch.ets", line: 51, col: 3 });
                ViewPU.create(componentCall);
                let paramsLambda = () => {
                    return {};
                };
            ...
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    let componentCall = new SearchInput(this, {
                        searchValue: this.__searchValue
                    }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/generated/detail/SecondPageSearch.ets", line: 68, col: 7 });
                    ViewPU.create(componentCall);
                    let paramsLambda = () => {
                        return {
                            searchValue: this.searchValue
