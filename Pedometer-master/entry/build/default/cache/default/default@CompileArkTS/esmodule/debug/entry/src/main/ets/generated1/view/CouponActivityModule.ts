...
interface CouponActivityModuleTitleInfo_Params {
...
interface CouponActivityModule_Params {
    itemModel?: Data;
    listDirection?: Axis;
    moduleTitle?: string;
    moduleRedirectContent?: string;
...
import { Data } from "@normalized:N&&&entry/src/main/ets/generated1/viewmodel/CouponActivityModuleData&";
import type { DataSource } from "@normalized:N&&&entry/src/main/ets/generated1/viewmodel/CouponActivityModuleData&";
...
export class CouponActivityModule extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        ...
        this.__moduleTitle = new ObservedPropertySimplePU("健康运动优惠与推荐", this, "moduleTitle");
    ...
    setInitiallyProvidedValue(params: CouponActivityModule_Params) {
    ...
    updateStateVars(params: CouponActivityModule_Params) {
    ...
    initialRender() {
        ...
        }, Column);
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    let componentCall = new CouponActivityModuleTitleInfo(this, {
                        title: this.moduleTitle,
                        moduleRedirectContent: this.moduleRedirectContent,
                        onJump: () => {
                            this.jump();
                        }
                    }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/generated1/view/CouponActivityModule.ets", line: 59, col: 9 });
            ...
            }, { name: "CouponActivityModuleTitleInfo" });
        }
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            If.create();
                        ...
                        const __lazyForEachItemGenFunction = (_item, index: number) => {
                            const item = _item;
                            {
                                const itemCreation2 = (elmtId, isInitialRender) => {
                                    ...
                                    ListItem.width('43.4%');
                                    ListItem.onClick(() => {
                                        this.jump("CouponActivityModuleDetail" + index.toString());
                                    });
                                };
                                        ...
                                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                                            if (isInitialRender) {
                                                let componentCall = new VerticalGraphicTextItem(this, {
                                                    ...
                                                    title: item.getTitle()
                                                }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/generated1/view/CouponActivityModule.ets", line: 76, col: 17 });
                                                ViewPU.create(componentCall);
                                                let paramsLambda = () => {
                                                    return {
                                                        image: item.getImage(),
...
export class VerticalGraphicTextItem extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.clip(true);
            Column.backgroundColor({ "id": 16777284, "type": 10001, params: [], "bundleName": "com.example.pedometerapp", "moduleName": "entry" });
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            /**
             * TODO:
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
             ...
             * @see Data#getResources()
             */
            Text.padding({ bottom: 12, left: 12, right: 12 });
        }, Text);
        /**
         * TODO:
         * please modify it according to the actual situation.
...
export class CouponActivityModuleTitleInfo extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        super(parent, __localStorage, elmtId, extraInfo);
        if (typeof paramsLambda === "function") {
            this.paramsGenerator_ = paramsLambda;
    ...
    setInitiallyProvidedValue(params: CouponActivityModuleTitleInfo_Params) {
        if (params.title !== undefined) {
            this.title = params.title;
        }
        if (params.moduleRedirectContent !== undefined) {
    ...
    updateStateVars(params: CouponActivityModuleTitleInfo_Params) {
    }
    purgeVariableDependenciesOnElmtId(rmElmtId) {
        this.__currentWidthBreakpoint.purgeDependencyOnElmtId(rmElmtId);
        this.__appPathStack.purgeDependencyOnElmtId(rmElmtId);
