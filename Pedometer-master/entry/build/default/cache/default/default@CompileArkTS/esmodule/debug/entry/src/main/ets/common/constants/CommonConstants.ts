...
export class CommonConstants {
     ...
     * 默认步数目标
     */
    static readonly DEFAULT_STEP_GOAL: number = 10000;
    /**
     * 久坐提醒阈值（分钟）
     */
    static readonly SEDENTARY_THRESHOLD_MINUTES: number = 60;
    /**
     * 久坐提醒检查间隔（分钟）
     */
    static readonly SEDENTARY_CHECK_INTERVAL_MINUTES: number = 1;
    /**
     * 卡路里计算系数
     * 步行每公里消耗约0.75 * 体重(kg)千卡
     */
    static readonly CALORIES_PER_KM_FACTOR: number = 0.75;
    /**
     * 默认步幅（米）
     */
    static readonly DEFAULT_STRIDE_LENGTH: number = 0.7;
    /**
     * 默认体重（千克）
     */
    static readonly DEFAULT_WEIGHT: number = 70;
    /**
     * 默认身高（厘米）
     */
    static readonly DEFAULT_HEIGHT: number = 170;
    /**
     * 数据库文件名
     */
    static readonly DB_NAME: string = 'StepHistory.db';
    /**
     * 久坐提醒通知ID
     */
    static readonly SEDENTARY_NOTIFICATION_ID: number = 1001;
    /**
     * 目标达成通知ID
     */
    static readonly GOAL_NOTIFICATION_ID: number = 1002;
    /**
     * 历史数据保留天数
     */
    static readonly HISTORY_RETENTION_DAYS: number = 90;
    /**
     * 图表数据缓存键
     */
    static readonly CHART_DATA_CACHE_KEY: string = 'CHART_DATA_CACHE';
    /**
     * 用户配置缓存键
     */
    static readonly USER_PROFILE_KEY: string = 'USER_PROFILE';
    /**
     * 久坐提醒开关键
     */
    static readonly SEDENTARY_REMINDER_ENABLED: string = 'SEDENTARY_REMINDER_ENABLED';
    /**
     * 目标达成弹窗已显示标记键
     */
    static readonly GOAL_DIALOG_SHOWN_TODAY: string = 'GOAL_DIALOG_SHOWN_TODAY';
    /**
     * 目标达成提醒开关键
     */
    static readonly GOAL_REMINDER_ENABLED: string = 'GOAL_REMINDER_ENABLED';
    /**
     * 每日目标提醒开关键
     */
    static readonly DAILY_REMINDER_ENABLED: string = 'DAILY_REMINDER_ENABLED';
    /**
     * 提醒设置键
     */
    static readonly REMINDER_SETTINGS_KEY: string = 'REMINDER_SETTINGS';
}
