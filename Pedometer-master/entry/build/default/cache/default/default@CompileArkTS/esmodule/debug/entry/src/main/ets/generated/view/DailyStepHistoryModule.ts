...
interface DailyStepHistoryModuleTitleInfo_Params {
...
interface DailyStepHistoryModule_Params {
    itemModel?: Data;
    listDirection?: Axis;
    moduleTitle?: string;
    moduleRedirectContent?: string;
...
import { Data } from "@normalized:N&&&entry/src/main/ets/generated/viewmodel/DailyStepHistoryModuleData&";
import type { DataSource } from "@normalized:N&&&entry/src/main/ets/generated/viewmodel/DailyStepHistoryModuleData&";
...
export class DailyStepHistoryModule extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        ...
        this.__moduleTitle = new ObservedPropertySimplePU("历史记录", this, "moduleTitle");
    ...
    setInitiallyProvidedValue(params: DailyStepHistoryModule_Params) {
    ...
    updateStateVars(params: DailyStepHistoryModule_Params) {
    ...
    initialRender() {
        ...
        }, Column);
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    let componentCall = new DailyStepHistoryModuleTitleInfo(this, {
                        title: this.moduleTitle,
                        moduleRedirectContent: this.moduleRedirectContent,
                        onJump: () => {
                            this.jump();
                        }
                    }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/generated/view/DailyStepHistoryModule.ets", line: 60, col: 9 });
            ...
            }, { name: "DailyStepHistoryModuleTitleInfo" });
        }
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            If.create();
                        ...
                        const __lazyForEachItemGenFunction = (_item, index: number) => {
                            const item = _item;
                            {
                                const itemCreation2 = (elmtId, isInitialRender) => {
                                    ...
                                    ListItem.onClick(() => {
                                        this.jump("DailyStepHistoryModuleDetail" + index.toString());
                                    });
                                };
                                    ...
                                    this.observeComponentCreation2(itemCreation2, ListItem);
                                    {
                                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                                            if (isInitialRender) {
                                                ...
                                                }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/generated/view/DailyStepHistoryModule.ets", line: 77, col: 17 });
                                                ViewPU.create(componentCall);
                                                let paramsLambda = () => {
                                                    return {
                                                        image: item.getImage(),
...
export class DailyStepHistoryModuleTitleInfo extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        super(parent, __localStorage, elmtId, extraInfo);
        if (typeof paramsLambda === "function") {
            this.paramsGenerator_ = paramsLambda;
    ...
    setInitiallyProvidedValue(params: DailyStepHistoryModuleTitleInfo_Params) {
    ...
    updateStateVars(params: DailyStepHistoryModuleTitleInfo_Params) {
    }
    purgeVariableDependenciesOnElmtId(rmElmtId) {
        this.__currentWidthBreakpoint.purgeDependencyOnElmtId(rmElmtId);
        this.__appPathStack.purgeDependencyOnElmtId(rmElmtId);
