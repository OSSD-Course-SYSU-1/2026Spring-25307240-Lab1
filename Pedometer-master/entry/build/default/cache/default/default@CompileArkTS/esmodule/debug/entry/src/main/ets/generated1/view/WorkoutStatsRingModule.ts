...
interface WorkoutStatsRingModuleTitleInfo_Params {
...
interface WorkoutStatsRingModule_Params {
...
import { Data } from "@normalized:N&&&entry/src/main/ets/generated1/viewmodel/WorkoutStatsRingModuleData&";
import type { DataSource } from "@normalized:N&&&entry/src/main/ets/generated1/viewmodel/WorkoutStatsRingModuleData&";
...
export class WorkoutStatsRingModule extends ViewPU {
    ...
    setInitiallyProvidedValue(params: WorkoutStatsRingModule_Params) {
    ...
    updateStateVars(params: WorkoutStatsRingModule_Params) {
    }
    ...
    initialRender() {
        ...
        }, Column);
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    let componentCall = new WorkoutStatsRingModuleTitleInfo(this, {
                        title: this.moduleTitle,
                        moduleRedirectContent: this.moduleRedirectContent,
                        onJump: () => {
                            this.jump();
                        }
                    }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/generated1/view/WorkoutStatsRingModule.ets", line: 57, col: 7 });
            ...
            }, { name: "WorkoutStatsRingModuleTitleInfo" });
        }
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            If.create();
                    ...
                    }, Swiper);
                    {
                        const __lazyForEachItemGenFunction = (_item, index: number) => {
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                __Common__.create();
                                __Common__.onClick(() => {
                                    this.jump("WorkoutStatsRingModuleDetail" + index.toString());
                                });
                            }, __Common__);
                            {
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    if (isInitialRender) {
                                        let componentCall = new VerticalGraphicTextItem(this, {
                                            ...
                                            title: item.getTitle()
                                        }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/generated1/view/WorkoutStatsRingModule.ets", line: 70, col: 13 });
                                        ViewPU.create(componentCall);
                                        let paramsLambda = () => {
                                            return {
                                                image: item.getImage(),
...
export class WorkoutStatsRingModuleTitleInfo extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        super(parent, __localStorage, elmtId, extraInfo);
        if (typeof paramsLambda === "function") {
            this.paramsGenerator_ = paramsLambda;
    ...
    setInitiallyProvidedValue(params: WorkoutStatsRingModuleTitleInfo_Params) {
        if (params.title !== undefined) {
            this.title = params.title;
        }
        if (params.moduleRedirectContent !== undefined) {
    ...
    updateStateVars(params: WorkoutStatsRingModuleTitleInfo_Params) {
    }
    purgeVariableDependenciesOnElmtId(rmElmtId) {
        this.__currentWidthBreakpoint.purgeDependencyOnElmtId(rmElmtId);
        this.__appPathStack.purgeDependencyOnElmtId(rmElmtId);
