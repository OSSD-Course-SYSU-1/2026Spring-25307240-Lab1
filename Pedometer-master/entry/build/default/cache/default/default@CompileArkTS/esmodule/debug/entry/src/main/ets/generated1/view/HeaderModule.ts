...
import { DataSource } from "@normalized:N&&&entry/src/main/ets/generated1/viewmodel/HeaderModuleData&";
import type { DataSourceStyleAStyleA } from "@normalized:N&&&entry/src/main/ets/generated1/viewmodel/HeaderModuleData&";
...
export class HeaderModule extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        super(parent, __localStorage, elmtId, extraInfo);
        if (typeof paramsLambda === "function") {
            this.paramsGenerator_ = paramsLambda;
    ...
    setInitiallyProvidedValue(params: HeaderModule_Params) {
    ...
    updateStateVars(params: HeaderModule_Params) {
    }
    purgeVariableDependenciesOnElmtId(rmElmtId) {
        this.__appPathStack.purgeDependencyOnElmtId(rmElmtId);
        this.__currentWidthBreakpoint.purgeDependencyOnElmtId(rmElmtId);
                                        ...
                                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                                            if (isInitialRender) {
                                                let componentCall = new IconTextItem(this, {
                                                    ...
                                                    title: item.getTitle(),
                                                    iconColor: '#2196F3'
                                                }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/generated1/view/HeaderModule.ets", line: 92, col: 15 });
