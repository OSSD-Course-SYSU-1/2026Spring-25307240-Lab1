...
interface UserProfileModule_Params {
    vipIcon?: Resource;
    vipLevel?: string;
...
export class UserProfileModule extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        ...
        this.__vipLevel = new ObservedPropertySimplePU("黄金会员", this, "vipLevel");
        ...
        this.__vipFunctionTitle1 = new ObservedPropertySimplePU("专属课程", this, "vipFunctionTitle1");
        ...
        this.__vipFunctionTitle2 = new ObservedPropertySimplePU("营养计划", this, "vipFunctionTitle2");
    ...
    setInitiallyProvidedValue(params: UserProfileModule_Params) {
    ...
    updateStateVars(params: UserProfileModule_Params) {
    }
