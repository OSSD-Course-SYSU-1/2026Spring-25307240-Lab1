...
interface TrainingPlanCardModuleTitleInfo_Params {
...
interface TrainingPlanCardModule_Params {
    itemModel?: Data;
    listDirection?: Axis;
    moduleTitle?: string;
    moduleRedirectContent?: string;
...
import { Data } from "@normalized:N&&&entry/src/main/ets/generated1/viewmodel/TrainingPlanCardModuleData&";
import type { DataSource } from "@normalized:N&&&entry/src/main/ets/generated1/viewmodel/TrainingPlanCardModuleData&";
...
export class TrainingPlanCardModule extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        ...
        this.__moduleTitle = new ObservedPropertySimplePU("推荐训练", this, "moduleTitle");
        this.__moduleRedirectContent = new ObservedPropertySimplePU("开始", this, "moduleRedirectContent");
    ...
    setInitiallyProvidedValue(params: TrainingPlanCardModule_Params) {
    ...
    updateStateVars(params: TrainingPlanCardModule_Params) {
    ...
    initialRender() {
        ...
        }, Column);
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    let componentCall = new TrainingPlanCardModuleTitleInfo(this, {
                        title: this.moduleTitle,
                        moduleRedirectContent: this.moduleRedirectContent,
                        onJump: () => {
                            this.jump();
                        }
                    }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/generated1/view/TrainingPlanCardModule.ets", line: 60, col: 9 });
            ...
            }, { name: "TrainingPlanCardModuleTitleInfo" });
        }
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            If.create();
                        ...
                        const __lazyForEachItemGenFunction = (_item, index: number) => {
                            const item = _item;
                            {
                                const itemCreation2 = (elmtId, isInitialRender) => {
                                    ...
                                    ListItem.onClick(() => {
                                        this.jump("TrainingPlanCardModuleDetail" + index.toString());
                                    });
                                };
                                    ...
                                    this.observeComponentCreation2(itemCreation2, ListItem);
                                    {
                                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                                            if (isInitialRender) {
                                                ...
                                                }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/generated1/view/TrainingPlanCardModule.ets", line: 77, col: 17 });
                                                ViewPU.create(componentCall);
                                                let paramsLambda = () => {
                                                    return {
                                                        image: item.getImage(),
...
export class TrainingPlanCardModuleTitleInfo extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        super(parent, __localStorage, elmtId, extraInfo);
        if (typeof paramsLambda === "function") {
            this.paramsGenerator_ = paramsLambda;
        ...
        this.title = '';
        this.moduleRedirectContent = "开始";
        this.__appPathStack = this.initializeConsume('appPathStack', "appPathStack");
        this.onJump = undefined;
        this.setInitiallyProvidedValue(params);
        this.finalizeConstruction();
    }
    setInitiallyProvidedValue(params: TrainingPlanCardModuleTitleInfo_Params) {
    ...
    updateStateVars(params: TrainingPlanCardModuleTitleInfo_Params) {
    }
    purgeVariableDependenciesOnElmtId(rmElmtId) {
        this.__currentWidthBreakpoint.purgeDependencyOnElmtId(rmElmtId);
        this.__appPathStack.purgeDependencyOnElmtId(rmElmtId);
