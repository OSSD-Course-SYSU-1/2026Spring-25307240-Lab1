    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            NavDestination.create(() => {
                ...
                }, Column);
                {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        if (isInitialRender) {
                            ...
                            }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/generated/detail/EmptyPagePathStack.ets", line: 24, col: 9 });
                ...
                Column.pop();
            }, { moduleName: "entry", pagePath: "entry/src/main/ets/generated/detail/EmptyPagePathStack" });
...
export function EmptyPagePathStackBuilder(parent = null) {
    {
        (parent ? parent : this).observeComponentCreation2((elmtId, isInitialRender) => {
            if (isInitialRender) {
                let componentCall = new EmptyPagePathStack(parent ? parent : this, {}, undefined, elmtId, () => { }, { page: "entry/src/main/ets/generated/detail/EmptyPagePathStack.ets", line: 43, col: 3 });
                ViewPU.create(componentCall);
                let paramsLambda = () => {
                    return {};
                };
