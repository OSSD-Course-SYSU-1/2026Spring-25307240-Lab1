...
interface DeviceConnectionStatusModule_Params {
    itemModel?: Data;
    listDirection?: Axis;
    moduleTitle?: string;
...
import { Data } from "@normalized:N&&&entry/src/main/ets/generated1/viewmodel/DeviceConnectionStatusModuleData&";
import type { DataSource } from "@normalized:N&&&entry/src/main/ets/generated1/viewmodel/DeviceConnectionStatusModuleData&";
export class DeviceConnectionStatusModule extends ViewPU {
    ...
    setInitiallyProvidedValue(params: DeviceConnectionStatusModule_Params) {
    ...
    updateStateVars(params: DeviceConnectionStatusModule_Params) {
                        ...
                        const __lazyForEachItemGenFunction = (_item, index: number) => {
                            const item = _item;
                            {
                                const itemCreation2 = (elmtId, isInitialRender) => {
                                    ...
                                    ListItem.height(60);
                                    ListItem.onClick(() => {
                                        this.jump("DeviceConnectionStatusModuleDetail" + index.toString());
                                    });
                                };
                                        ...
                                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                                            if (isInitialRender) {
                                                let componentCall = new VerticalGraphicTextFunctionItem1(this, {
                                                    title: item.getTitle(),
                                                    icon: item.getIcon()
                                                }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/generated1/view/DeviceConnectionStatusModule.ets", line: 68, col: 15 });
