...
interface FitnessProgressModuleTitleInfo_Params {
...
interface FitnessProgressModule_Params {
    itemModel?: Data;
    listDirection?: Axis;
    moduleTitle?: string;
    moduleRedirectContent?: string;
...
import { Data } from "@normalized:N&&&entry/src/main/ets/generated1/viewmodel/FitnessProgressModuleData&";
import type { DataSource } from "@normalized:N&&&entry/src/main/ets/generated1/viewmodel/FitnessProgressModuleData&";
...
export class FitnessProgressModule extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        ...
        this.__moduleTitle = new ObservedPropertySimplePU("健康运动步数统计", this, "moduleTitle");
        this.__moduleRedirectContent = new ObservedPropertySimplePU("查看更多运动数据", this, "moduleRedirectContent");
    ...
    setInitiallyProvidedValue(params: FitnessProgressModule_Params) {
    ...
    updateStateVars(params: FitnessProgressModule_Params) {
    ...
    initialRender() {
        ...
        }, Column);
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    let componentCall = new FitnessProgressModuleTitleInfo(this, {
                        title: this.moduleTitle,
                        moduleRedirectContent: this.moduleRedirectContent,
                        onJump: () => {
                            this.jump();
                        }
                    }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/generated1/view/FitnessProgressModule.ets", line: 60, col: 9 });
            ...
            }, { name: "FitnessProgressModuleTitleInfo" });
        }
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            If.create();
                        ...
                        const __lazyForEachItemGenFunction = (_item, index: number) => {
                            const item = _item;
                            {
                                const itemCreation2 = (elmtId, isInitialRender) => {
                                    ...
                                    ListItem.onClick(() => {
                                        this.jump("FitnessProgressModuleDetail" + index.toString());
                                    });
                                };
                                    ...
                                    this.observeComponentCreation2(itemCreation2, ListItem);
                                    {
                                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                                            if (isInitialRender) {
                                                ...
                                                }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/generated1/view/FitnessProgressModule.ets", line: 77, col: 17 });
                                                ViewPU.create(componentCall);
                                                let paramsLambda = () => {
                                                    return {
                                                        image: item.getImage(),
...
export class FitnessProgressModuleTitleInfo extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        super(parent, __localStorage, elmtId, extraInfo);
        if (typeof paramsLambda === "function") {
            this.paramsGenerator_ = paramsLambda;
        ...
        this.title = '';
        this.moduleRedirectContent = "查看更多运动数据";
        this.__appPathStack = this.initializeConsume('appPathStack', "appPathStack");
        this.onJump = undefined;
        this.setInitiallyProvidedValue(params);
        this.finalizeConstruction();
    }
    setInitiallyProvidedValue(params: FitnessProgressModuleTitleInfo_Params) {
    ...
    updateStateVars(params: FitnessProgressModuleTitleInfo_Params) {
    }
    purgeVariableDependenciesOnElmtId(rmElmtId) {
        this.__currentWidthBreakpoint.purgeDependencyOnElmtId(rmElmtId);
        this.__appPathStack.purgeDependencyOnElmtId(rmElmtId);
